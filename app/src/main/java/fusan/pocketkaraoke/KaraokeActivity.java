...
public class KaraokeActivity extends AppCompatActivity {
    ...
    class butClick implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String path;
            path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/PocketKaraoke/yourRec.pcm";
            File file1= new File(path);
            path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/PocketKaraoke/YourRecordings";
            filePath= new File(path);
            fileList = filePath.listFiles();
            int count = fileList.length;
            path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/PocketKaraoke/YourRecordings/yourRec"+(count+1)+".wav";
