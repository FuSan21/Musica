        ...
        public void onClick(View view) {
            ...
            switch(view.getId())
            {
                case R.id.btnStart:
                    ...
                    String ext1 = "/PocketKaraoke/YourRecordings/" + name;
                    try
                    {
                ...
                case R.id.btnPlayNew:
                    ...
                    String ext2 = "/PocketKaraoke/YourRecordings/" ;
                    try
                    {
                ...
                case R.id.btnPlayNew2:
                    ...
                    String ext3 = "/PocketKaraoke/YourRecordings/" ;
                    try
                    {
                ...
                case R.id.btnPlayNew3:
                    ...
                    String ext4 = "/PocketKaraoke/YourRecordings/" ;
                    try
                    {
    ...
    private class reverbButtonClick implements View.OnClickListener
    {
        ...
        public void onClick(View view) {
            ...
            try {
                ...
                String path1 = Environment.getExternalStorageDirectory().getAbsolutePath();
                String ext1 = "/PocketKaraoke/YourRecordings/";
